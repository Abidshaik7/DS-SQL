...
create database coffee_corner;
use coffee_corner;
insert into menu (id, Name, product_type, price, Expected_time, size, availability)
values(1, 'Cappuccino', 'Coffee', 150.00, '5 min', 'Medium', true),
(2, 'Espresso', 'Coffee', 100.00, '3 min', 'Small', true),
(3, 'Latte', 'Coffee', 180.00, '6 min', 'Large', false),
(4, 'Green Tea', 'Tea', 120.00, '4 min', 'Medium', true),
(5, 'Muffin', 'Snack', 90.00, '2 min', 'Regular', true),
(6, 'Croissant', 'Snack', 110.00, '3 min', 'Regular', true),
(7, 'Iced Americano', 'Coffee', 160.00, '7 min', 'Large', true);
select * from menu;
